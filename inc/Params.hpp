...
public:
		...
		std::string getPwdNetwork() const
		{return _password_network;}
		void setPwdNetwork(std::string & new_pwd)
		{ _password_network = ft_atoi(new_pwd.c_str());}
		...
		{return _port_network;}
		void setPortNetwork(std::string & new_port)
		{ _port_network = ft_atoi(new_port.c_str());}
